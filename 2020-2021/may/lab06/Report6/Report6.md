...
![Лишаем владельца файла или каталога прав и даем их ему](image6/8.png){ #fig:008 width=70% }
...
![Команда man mount](image6/9.png){ #fig:009 width=70% }
...
![Команда man kill](image6/12.png){ #fig:012 width=70% }
