...
![Использую команды ls –a /etc > file.txt, ls -a ~ » file.txt, cat file.txt ](image/1.png)
...
![Использую команды grep -e ‘\.conf$’ file.txt> conf.txt, cat conf.txt](image/2.png)
...
![Использую команды find ~ -maxdepth1 -name “c*” -print, ls ~/c*,ls –a ~ | grep c*](image/3.png)
...
![Использую команду find /etc –maxdepth1 –name “h*” | less](image/4.png)

![Вывод (постранично) имён файлов из каталога /etc, начинающиеся  с  символа h](image/5.png)
...
![Использую команду find/ -name “log*” > logfile &](image/6.png)

![Использую команду cat logfile](image/7.png)

![Использую команду cat logfile](image/8.png)

![Использую команду rm logfile](image/9.png)

7. Запускаю  редактор gedit в  фоновом  режиме  командой «gedit &» (рис. -@fig:010). После этого на экране появляется окно редактора.

![Использую команду gedit &](image/10.png)
...
![Использую команду ps| grep-i“gedit”](image/11.png)
...
![Использую команду man kill и открывается памятка о данной команде](image/12.png)


![Использую команду kill6386  для  завершения  процесса gedit](image/13.png)
...
![Использую команды man df и man du ](image/14.png)
 
![Памятка о команде df ](image/15.png)
 
![Памятка о команде du](image/16.png)

![Использую команды df и du](image/17.png)
...
![Использую команду man find и открывается памятка о данной команде](image/18.png)

![Использую команду find ~ -type d](image/19.png)
