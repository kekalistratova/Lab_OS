...
![GNOME](image4/gnome.png){ #fig:002 width=70% }

(рис. -@fig:003)

![Менеджер XFCE](image4/xfce.png){ #fig:003 width=70% }

(рис. -@fig:004)

![Оконный менеджер Openbox](image4/openbox.png){ #fig:004 width=70% }
